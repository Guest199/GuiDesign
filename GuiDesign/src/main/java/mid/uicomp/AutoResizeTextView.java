...
// yaniv - added to prevent issue of changing text programmatically
heightLimit = heightLimit > 0 ? heightLimit : 0;
mWidthLimit = mWidthLimit > 0 ? mWidthLimit : 0;

        mAvailableSpaceRect.right = mWidthLimit;
        mAvailableSpaceRect.bottom = heightLimit;

        int textSize =efficientTextSizeSearch(startSize,
                (int) mMaxTextSize,
                mSizeTester,
                mAvailableSpaceRect);

        super.setTextSize(TypedValue.COMPLEX_UNIT_PX,   (int)(textSize * 0.85));
    }
