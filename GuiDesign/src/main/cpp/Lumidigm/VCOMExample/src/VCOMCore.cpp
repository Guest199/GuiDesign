...
#include "../include/V100CommandHandler.h"
#include "../API/VCOMCore.h"
#include "../include/V100Cmd.h"
#include "../include/V100IDCmd.h"
...
#if 0
    // avoid scanning USB bus for socket transport
    if (pDev->uri != NULL)
    {
        if(0 != V100CommandHandler::GetCommandHandler(pDev)->Initialize(pDev))
